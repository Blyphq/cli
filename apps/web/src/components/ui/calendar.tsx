    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "absolute top-1 left-1 size-7 rounded-md p-0",
        ),
        button_next: cn(
          buttonVariants({ variant: "outline", size: "icon-sm" }),
          "absolute top-1 right-1 size-7 rounded-md p-0",
        ),
        ...
        day_button: cn(
          ...
          "size-9 rounded-md p-0 text-xs font-medium aria-selected:bg-primary aria-selected:text-primary-foreground",
        ),
